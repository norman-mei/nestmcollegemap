...
function StudentList() {
    _s();
    const { filteredStudents, filterState, setFilterState } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$FilterContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFilters"])();
    ...
    const groupedByGrad = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StudentList.useMemo[groupedByGrad]": ()=>{
            ...
            return Array.from(groups.entries()).sort({
                "StudentList.useMemo[groupedByGrad]": ([a], [b])=>a.localeCompare(b)
            }["StudentList.useMemo[groupedByGrad]"]);
        }
    }["StudentList.useMemo[groupedByGrad]"], [
        filteredStudents
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: filteredStudents.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 135,
                    columnNumber: 13
                }, this) : groupedByGrad.map(([gradClass, students])=>{
...
_s(StudentList, "Lo3jGn6QKKYm9BvnrhExJ5Imiy8=", false, function() {
    return [
...
_s(FilterPanel, "Bextv0L4lP+kfbR8iHg4/Nw/Cbs=", false, function() {
    return [
...
function MapMarkers({ students }) {
    ...
    const { theme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ThemeContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
    const { openPhotoPopup, activeHoverId, setActiveHoverId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$UIContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUI"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MapMarkers.useEffect": ()=>{
            ...
            const openStudentInfo = {
                "MapMarkers.useEffect.openStudentInfo": (student, marker)=>{
                    if (infowindowRef.current) {
                        const content = `
            ...
            const handleCenterEvent = {
                "MapMarkers.useEffect.handleCenterEvent": (e)=>{
                    ...
                    if (target && map) {
                        ...
                        openStudentInfo(students.find({
                            "MapMarkers.useEffect.handleCenterEvent": (s)=>s.id === e.detail.id
                        }["MapMarkers.useEffect.handleCenterEvent"]), target.marker);
...
_s(MapMarkers, "uQ1O0kekYF9r+Rppt7/mJJ4oXkI=", false, function() {
    return [
...
function MapControls() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-white/90 dark:bg-neutral-800/90 p-2 rounded shadow flex flex-wrap gap-2 pointer-events-auto backdrop-blur-sm border border-gray-200 dark:border-neutral-700",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: toggleTheme,
                        id: "darkModeToggle",
...
_s(MapControls, "SQEHeCRBfjGqpH1uukz/bpEX+7g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vis$2e$gl$2f$react$2d$google$2d$maps$2f$dist$2f$index$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMap"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ThemeContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$FilterContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFilters"]
...
'use client';
;
function getHighlightPosition(selector, padding = 8) {
...
function getDescriptionPosition(highlight, boxWidth = 320) {
    ...
    if (highlight.top + highlight.height + boxWidth / 2 + margin < viewportHeight + window.scrollY - 40) {
        return {
            ...
            left: Math.min(Math.max(highlight.left + highlight.width / 2 - boxWidth / 2, window.scrollX + 12), window.scrollX + viewportWidth - boxWidth - 12),
            arrow: 'top'
        };
    }
    // Else place above
...
function TutorialTour({ onClose }) {
        ...
        "TutorialTour.useMemo[steps]": ()=>[
                {
                    ...
                    title: 'Filters',
                    text: 'Filter by graduating class, major area, and region. Everything updates instantly.'
                },
                {
                    selector: '#statistics-section',
                    title: 'Attendance Stats',
                    text: 'Quick totals by region, public/private mix, and top colleges for the current filters.'
                },
                {
                    selector: '#trend-section',
                    title: 'Trends',
                    text: 'See how majors, regions, and top colleges change across graduating years.'
                },
                {
                    selector: '#student-list-section',
                    title: 'List & Gallery',
                    text: 'Hover to preview, click to open photos, and collapse by class. Use gallery for photo-first browsing.'
                },
                {
                    selector: '#map-controls-bar',
                    title: 'Map Controls',
                    text: 'Toggle dark mode, map/satellite, transit layer, reset view, and clear filters.'
                },
                {
                    selector: '#map-area',
                    title: 'Interactive Map',
                    text: 'Click markers to open info windows and sync with the list/photo popup.'
                }
            ]
    }["TutorialTour.useMemo[steps]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TutorialTour.useEffect": ()=>{
            if (!isOpen) return;
            const update = {
                "TutorialTour.useEffect.update": ()=>setHighlight(getHighlightPosition(steps[current]?.selector))
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            highlight && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed z-[12001] border-2 border-blue-400 rounded-md pointer-events-none",
                style: {
                    top: highlight.top,
                    left: highlight.left,
...
_s(TutorialTour, "rIDqRtpszsLUCTvrhaYESG/Y5o8=");
_c = TutorialTour;
var _c;
...
const faqEntries = [
    {
        ...
        a: 'Whenever new seniors/updates are available. This is a manual process, so cadence varies.'
    },
    {
        q: 'Where do photos and captions come from?',
        a: 'From publicly shared class decision posts and voluntary submissions. No private data is collected.'
    },
    {
        q: 'Why can’t I see a specific senior?',
        a: 'They may be filtered out, hidden individually, or missing data. Clear filters or check their visibility.'
    },
    {
        q: 'Can I request a change?',
        a: 'Yes—send an update with the correct name, class, college, or photo link.'
    }
];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ModalShell, {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-4",
                    children: releaseNotes.map((r)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(InfoModals, "F+HF7E44TJoVYMpzyxA/zjpHr2w=");
_c1 = InfoModals;
var _c, _c1;
...
//# sourceMappingURL=src_components_f9871993._.js.map