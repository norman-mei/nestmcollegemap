...
function getMajorArea(specificMajor) {
    ...
    let mappedArea = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$majors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["majorToAreaMapping"][lowerSpecificMajor];
...
const DataProvider = ({ children })=>{
    ...
    const allStudents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DataProvider.useMemo[allStudents]": ()=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseRawData"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$students$2e$json__$28$json$29$__["default"]);
        }
    }["DataProvider.useMemo[allStudents]"], []);
...
const FilterProvider = ({ children })=>{
    ...
    const initialStateCountry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FilterProvider.useMemo[initialStateCountry]": ()=>{
            const map = {};
            allStudents.forEach({
                "FilterProvider.useMemo[initialStateCountry]": (s)=>{
    ...
    const [hiddenStudents, setHiddenStudents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "FilterProvider.useState": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            try {
                const stored = JSON.parse(localStorage.getItem('hiddenStudents') || '[]');
    ...
    const [hiddenColleges, setHiddenColleges] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "FilterProvider.useState": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            try {
                const stored = JSON.parse(localStorage.getItem('hiddenColleges') || '[]');
                return new Set(stored);
            } catch  {
                return new Set();
            }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FilterProvider.useEffect": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            try {
                const storedHidden = JSON.parse(localStorage.getItem('hiddenStudents') || '[]');
                setHiddenStudents(new Set(storedHidden));
                const storedColleges = JSON.parse(localStorage.getItem('hiddenColleges') || '[]');
...
_s(FilterProvider, "p1I1Lur63OlJAv0fweAKJhq+h/s=", false, function() {
    return [
...
//# sourceMappingURL=src_003578aa._.js.map